...
<h3 align="center">soy un estudiante de backend apasionado</h3>

- Estoy estudiando Desarrollo de Aplicaciones Multiplataforma con especialidad en DevOps (DAM)M **Java , Python , SQL, PL/SQL, HTML, CSS**
